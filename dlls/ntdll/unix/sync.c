...
NTSTATUS WINAPI GPT_IMPORT(NtCreateSemaphore)( HANDLE *handle, ACCESS_MASK access, const OBJECT_ATTRIBUTES *attr, // From WineCX_24.0.5
...
NTSTATUS WINAPI GPT_IMPORT(NtReleaseSemaphore)( HANDLE handle, ULONG count, ULONG *previous ) // From WineCX_24.0.5
{
    unsigned int ret;
...
NTSTATUS WINAPI GPT_IMPORT(NtCreateEvent)( HANDLE *handle, ACCESS_MASK access, const OBJECT_ATTRIBUTES *attr, // From WineCX_24.0.5
...
NTSTATUS WINAPI GPT_IMPORT(NtSetEvent)( HANDLE handle, LONG *prev_state ) //From WineCX_24.0.5
{
    unsigned int ret;
...
NTSTATUS WINAPI GPT_IMPORT(NtResetEvent)( HANDLE handle, LONG *prev_state ) //From WineCX_24.0.5
{
    unsigned int ret;
...
NTSTATUS WINAPI GPT_IMPORT(NtClearEvent)( HANDLE handle ) //From WineCX_24.0.5
{
...
NTSTATUS WINAPI GPT_IMPORT(NtPulseEvent)( HANDLE handle, LONG *prev_state ) // From WineCX_24.0.5
{
    unsigned int ret;
